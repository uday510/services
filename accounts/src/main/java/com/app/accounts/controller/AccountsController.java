...
public class AccountsController {
        ...
        public AccountsController(
                        ...
                        IAccountService iAccountService, Environment environment,
        ...
        public ResponseEntity<SuccessResponseDto<String>> createAccount(
                        @Valid @RequestBody CustomerDto customerDto, HttpServletRequest request) {
                iAccountService.createAccount(customerDto);

                SuccessResponseDto<String> response = SuccessResponseDto.of(request.getRequestURI(),
                                HttpStatus.CREATED, HttpStatus.CREATED.getReasonPhrase(), null);
        ...
        // @GetMapping(path = {"", "/"} )
        @GetMapping
        public ResponseEntity<SuccessResponseDto<CustomerDto>> fetchAccount(@RequestParam @Pattern(
                        regexp = "(^$|[0-9]{10})",
                ...
                SuccessResponseDto<CustomerDto> response =
                                SuccessResponseDto.of(request.getRequestURI(), HttpStatus.OK,
                                                HttpStatus.OK.getReasonPhrase(), customerDto);
        ...
        // @PutMapping(path = {"", "/"})
        @PutMapping
        public ResponseEntity<SuccessResponseDto<Object>> updateAccount(
                        @Valid @RequestBody CustomerDto dto, HttpServletRequest request) {
                Map<String, Object> data = new HashMap<>();
                data.put("status", "updated");
                data.put("success", true);

                iAccountService.updateAccount(dto);
                SuccessResponseDto<Object> response = SuccessResponseDto.of(request.getRequestURI(),
                                HttpStatus.OK, HttpStatus.OK.getReasonPhrase(), data);
        ...
        // @DeleteMapping(path = {"", "/"})
        @DeleteMapping
        public ResponseEntity<SuccessResponseDto<Object>> deleteAccount(@RequestParam @Pattern(
                        regexp = "(^$|[0-9]{10})",
                        message = "Mobile number must be 10 digits") String mobileNumber,
                        HttpServletRequest request) {
                Map<String, Object> data = new HashMap<>();
        ...
        public ResponseEntity<SuccessResponseDto<String>> getBuildInfo(HttpServletRequest request) {
                ...
                SuccessResponseDto<String> response = SuccessResponseDto.of(request.getRequestURI(),
                                HttpStatus.OK, HttpStatus.OK.getReasonPhrase(), buildVersion);

                return ResponseEntity.status(HttpStatus.OK).body(response);
        }

        public ResponseEntity<SuccessResponseDto<String>> getBuildInfoFallback(
                        HttpServletRequest request, Throwable throwable) {

                SuccessResponseDto<String> response = SuccessResponseDto.of(request.getRequestURI(),
                                HttpStatus.OK, HttpStatus.OK.getReasonPhrase(),
        ...
        @Operation(summary = "Fetch JAVA Version REST API",
                        description = "REST API to fetch Java version information")
        @ApiResponse(responseCode = "200", description = "HTTP Status OK")
        @GetMapping("/java-version")
        public ResponseEntity<SuccessResponseDto<String>> getJavaVersion(
                        HttpServletRequest request) {
        ...
        @Operation(summary = "Fetch Maven Version REST API",
        ...
        @ApiResponse(responseCode = "200", description = "HTTP Status OK")
        @GetMapping("/contact")
        public ResponseEntity<SuccessResponseDto<AccountsContactInfoDto>> getContactInfo(
                        HttpServletRequest request) {

                SuccessResponseDto<AccountsContactInfoDto> response = SuccessResponseDto.of(
                                request.getRequestURI(), HttpStatus.OK,
                                HttpStatus.OK.getReasonPhrase(), accountsContactInfoDto);

                return ResponseEntity.status(HttpStatus.OK).body(response);
        }

        public ResponseEntity<SuccessResponseDto<String>> getJavaVersionFallback(
                        HttpServletRequest request, Throwable throwable) {
