...
@Tag(name = "CRUD REST APIs for Cards in Cards Service", description = "CRUD REST APIs in Cards Service to CREATE, UPDATE, FETCH AND DELETE card details")
@RestController
...
public class CardsController {
        ...
        @Operation(summary = "Create Card REST API", description = "REST API to create new Card inside Cards Service")
        @ApiResponses({
                        @ApiResponse(responseCode = "201", description = "HTTP Status CREATED"),
                        @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class)))
        })
        @PostMapping
        public ResponseEntity<SuccessResponseDto<String>> createCard(
        ...
        public ResponseEntity<SuccessResponseDto<CardsDto>> fetchCardDetails(
                ...
                // try {
                //         Thread.sleep(10_000);
                //         logger.debug("Thread is sleeping...");
        ...
        @PutMapping
        public ResponseEntity<SuccessResponseDto<Object>> updateCardDetails(@Valid @RequestBody CardsDto cardsDto,
                        HttpServletRequest request) {
        ...
        @DeleteMapping
        public ResponseEntity<SuccessResponseDto<Object>> deleteCardAccount(
                        @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber,
                        HttpServletRequest request) {
                Map<String, Object> data = new HashMap<>();
